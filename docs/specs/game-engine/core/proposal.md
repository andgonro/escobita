...
- Scoring at end of round awards points for: each escoba earned during the round (1 point each), most cards captured (1 point; 2 points if the player captured all 40 cards), most Oros captured (1 point; 2 points if the player captured all 10 Oros), most sevens captured (1 point; 2 points if the player captured all 4 sevens), and possession of the Siete de Velo (7 of Oros, 1 point). On any tie within a category, no one receives that point.
