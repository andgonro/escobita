Feature: Laia hand capture animation bleed

  Rule: Human Capture Animation Isolation
  ...
  Rule: Opponent Hand Animation Eligibility
  ...
  Rule: Negative Validation for Cross-Zone Animation Bleed
  ...
  Rule: Regression Stability Across Repeated Captures
  ...
  Rule: Non-Functional Preservation After Isolation Fix
