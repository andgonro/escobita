...
var FORM_FIELD_PARSE_ERRORS = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "FORM_FIELD_PARSE_ERRORS" : "");
...
function nativeControlCreate(host, parent, parseErrorsSource) {
  ...
  const parser = createParser(() => parent.state().value(), (rawValue) => parent.state().controlValue.set(rawValue), () => getNativeControlValue(input2, parent.state().value));
...
function Lobby_Conditional_32_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
...
function Lobby_Conditional_32_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 14)(1, "label", 15);
    \u0275\u0275text(2, "Nombre del jugador");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "input", 16);
    \u0275\u0275listener("blur", function Lobby_Conditional_32_Template_input_blur_3_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onSingleNameBlur());
    });
    \u0275\u0275elementEnd();
    \u0275\u0275controlCreate();
    \u0275\u0275conditionalCreate(4, Lobby_Conditional_32_Conditional_4_Template, 2, 0, "p", 17);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 18)(6, "p", 19);
    \u0275\u0275text(7, "Oponente IA");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "p", 20);
    \u0275\u0275text(9, "Laia");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "div", 14)(11, "label", 21);
    \u0275\u0275text(12, "Dificultad");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "select", 22);
    \u0275\u0275listener("change", function Lobby_Conditional_32_Template_select_change_13_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onDifficultyChange($event.target.value));
    });
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275property("formField", ctx_r1.singlePlayerForm.name);
    \u0275\u0275attribute("aria-invalid", ctx_r1.singleNameErrorVisible())("aria-describedby", ctx_r1.singleNameErrorVisible() ? "single-player-name-error" : null);
    \u0275\u0275control();
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.singleNameErrorVisible() ? 4 : -1);
    \u0275\u0275advance(9);
    \u0275\u0275property("value", ctx_r1.aiDifficulty());
  }
}
function Lobby_Conditional_33_For_12_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const playerIndex_r5 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275property("id", "multiplayer-name-error-" + (playerIndex_r5 + 1));
    \u0275\u0275attribute("data-testid", "multiplayer-name-error-" + (playerIndex_r5 + 1));
  }
}
function Lobby_Conditional_33_For_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 14)(1, "label", 32);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "input", 33);
    \u0275\u0275listener("blur", function Lobby_Conditional_33_For_12_Template_input_blur_3_listener() {
      const playerIndex_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.onMultiplayerNameBlur(playerIndex_r5));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275controlCreate();
    \u0275\u0275conditionalCreate(4, Lobby_Conditional_33_For_12_Conditional_4_Template, 2, 2, "p", 34);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const playerIndex_r5 = ctx.$implicit;
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("for", "multiplayer-name-" + (playerIndex_r5 + 1));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" Jugador ", playerIndex_r5 + 1, " ");
    \u0275\u0275advance();
    \u0275\u0275property("id", "multiplayer-name-" + (playerIndex_r5 + 1))("formField", ctx_r1.multiplayerForm.playerNames[playerIndex_r5]);
    \u0275\u0275attribute("data-testid", "multiplayer-name-" + (playerIndex_r5 + 1))("aria-invalid", ctx_r1.isMultiplayerNameErrorVisible(playerIndex_r5))("aria-describedby", ctx_r1.isMultiplayerNameErrorVisible(playerIndex_r5) ? "multiplayer-name-error-" + (playerIndex_r5 + 1) : null);
    \u0275\u0275control();
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.isMultiplayerNameErrorVisible(playerIndex_r5) ? 4 : -1);
  }
}
function Lobby_Conditional_33_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 14)(1, "label", 26);
    \u0275\u0275text(2, "Cantidad de jugadores");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "select", 27);
    \u0275\u0275listener("change", function Lobby_Conditional_33_Template_select_change_3_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onPlayerCountChange($event.target.value));
    });
    ...
    \u0275\u0275repeaterCreate(11, Lobby_Conditional_33_For_12_Template, 5, 8, "div", 14, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275property("value", ctx_r1.multiplayerPlayerCount());
    \u0275\u0275advance(8);
    \u0275\u0275repeater(ctx_r1.visibleMultiplayerIndexes());
  }
}
var Lobby = class _Lobby {
  ...
  mode = signal("Single Player", ...ngDevMode ? [{ debugName: "mode" }] : (
    /* istanbul ignore next */
    []
  ));
  aiDifficulty = signal("Easy", ...ngDevMode ? [{ debugName: "aiDifficulty" }] : (
    /* istanbul ignore next */
    []
  ));
  multiplayerPlayerCount = signal(2, ...ngDevMode ? [{ debugName: "multiplayerPlayerCount" }] : (
    /* istanbul ignore next */
    []
  ));
  singlePlayerModel = signal({
    name: "Jugador-1"
  }, ...ngDevMode ? [{ debugName: "singlePlayerModel" }] : (
    /* istanbul ignore next */
    []
  ));
  singlePlayerForm = form(this.singlePlayerModel);
  multiplayerModel = signal({
    playerNames: ["Jugador-1", "Jugador-2", "Jugador-3", "Jugador-4"]
  }, ...ngDevMode ? [{ debugName: "multiplayerModel" }] : (
    /* istanbul ignore next */
    []
  ));
  multiplayerForm = form(this.multiplayerModel);
  singleNameBlurred = signal(false, ...ngDevMode ? [{ debugName: "singleNameBlurred" }] : (
    /* istanbul ignore next */
    []
  ));
  multiplayerNameBlurred = signal([
    false,
    false,
    false,
    false
  ], ...ngDevMode ? [{ debugName: "multiplayerNameBlurred" }] : (
    /* istanbul ignore next */
    []
  ));
  isSinglePlayerMode = computed(() => this.mode() === "Single Player", ...ngDevMode ? [{ debugName: "isSinglePlayerMode" }] : (
    /* istanbul ignore next */
    []
  ));
  visibleMultiplayerIndexes = computed(() => Array.from({ length: this.multiplayerPlayerCount() }, (_, index) => index), ...ngDevMode ? [{ debugName: "visibleMultiplayerIndexes" }] : (
    /* istanbul ignore next */
    []
  ));
  singleNameErrorVisible = computed(() => this.isSinglePlayerMode() && this.singleNameBlurred() && this.isBlank(this.singlePlayerForm.name().value()), ...ngDevMode ? [{ debugName: "singleNameErrorVisible" }] : (
    /* istanbul ignore next */
    []
  ));
  isPlayDisabled = computed(() => this.currentPlayerNames().some((name) => this.isBlank(name)), ...ngDevMode ? [{ debugName: "isPlayDisabled" }] : (
    /* istanbul ignore next */
    []
  ));
  setMode(nextMode) {
  ...
  isMultiplayerNameErrorVisible(index) {
  ...
  hydrateFromSessionConfiguration() {
  ...
  buildMultiplayerPrefill(playerNames) {
  ...
  static \u0275fac = function Lobby_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _Lobby)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Lobby, selectors: [["app-lobby"]], decls: 36, vars: 4, consts: [[1, "lobby-layout"], ["aria-labelledby", "lobby-title", 1, "hero"], [1, "hero-card"], [1, "eyebrow"], ["id", "lobby-title"], [1, "hero-copy"], ["data-testid", "hero-decoration", "aria-hidden", "true", 1, "hero-decoration"], ["aria-label", "Configuracion de la partida", 1, "setup-panel"], [1, "mode-selector"], ["for", "mode-single", 1, "radio-chip"], ["id", "mode-single", "type", "radio", "name", "game-mode", "data-testid", "mode-single", 3, "change", "keydown.arrowright", "keydown.arrowdown", "checked"], ["for", "mode-multiplayer", 1, "radio-chip"], ["id", "mode-multiplayer", "type", "radio", "name", "game-mode", "data-testid", "mode-multiplayer", 3, "change", "keydown.arrowleft", "keydown.arrowup", "checked"], ["type", "button", "data-testid", "play-button", 1, "play-button", 3, "click", "disabled"], [1, "field-group"], ["for", "single-player-name"], ["id", "single-player-name", "type", "text", "data-testid", "single-player-name", 3, "blur", "formField"], ["id", "single-player-name-error", "data-testid", "single-player-name-error", "role", "alert", 1, "error-text"], [1, "field-group", "ai-opponent"], [1, "field-label"], ["data-testid", "ai-name", 1, "ai-name"], ["for", "ai-difficulty"], ["id", "ai-difficulty", "data-testid", "ai-difficulty", 3, "change", "value"], ["value", "Easy"], ["value", "Medium"], ["value", "Hard"], ["for", "player-count"], ["id", "player-count", "data-testid", "player-count", 3, "change", "value"], ["value", "2"], ["value", "3"], ["value", "4"], [1, "multiplayer-fields"], [3, "for"], ["type", "text", 3, "blur", "id", "formField"], ["role", "alert", 1, "error-text", 3, "id"]], template: function Lobby_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "main", 0)(1, "section", 1)(2, "div", 2)(3, "p", 3);
      \u0275\u0275text(4, "Juego de cartas tradicional");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(5, "h1", 4);
      \u0275\u0275text(6, "La Escobini Kapitxorna");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(7, "p", 5);
      \u0275\u0275text(8, "Configura la partida y empieza a jugar.");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275text(17, "BASTOS");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(18, "section", 7)(19, "h2");
      \u0275\u0275text(20, "Configurar partida");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(21, "fieldset", 8)(22, "legend");
      \u0275\u0275text(23, "Modo de juego");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(24, "label", 9)(25, "input", 10);
      \u0275\u0275listener("change", function Lobby_Template_input_change_25_listener() {
        return ctx.setMode("Single Player");
      })("keydown.arrowright", function Lobby_Template_input_keydown_arrowright_25_listener() {
        return ctx.setMode("Multiplayer");
      })("keydown.arrowdown", function Lobby_Template_input_keydown_arrowdown_25_listener() {
        return ctx.setMode("Multiplayer");
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(26, "span");
      \u0275\u0275text(27, "Un Jugador");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(28, "label", 11)(29, "input", 12);
      \u0275\u0275listener("change", function Lobby_Template_input_change_29_listener() {
        return ctx.setMode("Multiplayer");
      })("keydown.arrowleft", function Lobby_Template_input_keydown_arrowleft_29_listener() {
        return ctx.setMode("Single Player");
      })("keydown.arrowup", function Lobby_Template_input_keydown_arrowup_29_listener() {
        return ctx.setMode("Single Player");
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(30, "span");
      \u0275\u0275text(31, "Multi jugador");
      \u0275\u0275elementEnd()()();
      \u0275\u0275conditionalCreate(32, Lobby_Conditional_32_Template, 20, 5)(33, Lobby_Conditional_33_Template, 13, 1);
      \u0275\u0275elementStart(34, "button", 13);
      \u0275\u0275listener("click", function Lobby_Template_button_click_34_listener() {
    ...
    if (rf & 2) {
      \u0275\u0275advance(25);
      \u0275\u0275property("checked", ctx.isSinglePlayerMode());
      \u0275\u0275advance(4);
      \u0275\u0275property("checked", !ctx.isSinglePlayerMode());
      \u0275\u0275advance(3);
      \u0275\u0275conditional(ctx.isSinglePlayerMode() ? 32 : 33);
      \u0275\u0275advance(2);
      \u0275\u0275property("disabled", ctx.isPlayDisabled());
    }
  }, dependencies: [FormField], styles: ["\n[_nghost-%COMP%] {\n  display: block;\n}\n.lobby-layout[_ngcontent-%COMP%] {\n  min-height: 100dvh;\n  display: grid;\n  gap: 1.5rem;\n  padding: clamp(1rem, 3vw, 2.5rem);\n  align-items: stretch;\n}\n.hero[_ngcontent-%COMP%], \n.setup-panel[_ngcontent-%COMP%] {\n  border-radius: 1.25rem;\n  box-shadow: 0 12px 30px rgba(18, 36, 52, 0.12);\n}\n.hero[_ngcontent-%COMP%] {\n  background:\n    linear-gradient(\n      160deg,\n      #ffd3ab,\n      #a6e8ee);\n  color: #0f2c3a;\n  overflow: hidden;\n}\n.hero-card[_ngcontent-%COMP%] {\n  height: 100%;\n  padding: clamp(1.25rem, 3vw, 2.5rem);\n  display: grid;\n  gap: 0.85rem;\n  align-content: center;\n}\n.eyebrow[_ngcontent-%COMP%] {\n  margin: 0;\n  text-transform: uppercase;\n  letter-spacing: 0.08em;\n  font-weight: 700;\n  font-size: 0.78rem;\n  opacity: 0.9;\n}\nh1[_ngcontent-%COMP%] {\n  margin: 0;\n  font-family: var(--font-display);\n  line-height: 1;\n  font-size: clamp(2.2rem, 6vw, 4rem);\n}\n.hero-copy[_ngcontent-%COMP%] {\n  margin: 0;\n  max-width: 30ch;\n  line-height: 1.5;\n}\n.hero-decoration[_ngcontent-%COMP%] {\n  margin-top: 0.75rem;\n  display: flex;\n  gap: 0.55rem;\n  flex-wrap: wrap;\n}\n.hero-decoration[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  min-height: 2.75rem;\n  padding: 0.45rem 0.9rem;\n  border-radius: 999px;\n  background: rgba(255, 255, 255, 0.55);\n  border: 1px solid rgba(15, 44, 58, 0.25);\n  color: #123746;\n  font-size: 0.85rem;\n  font-weight: 700;\n}\n.setup-panel[_ngcontent-%COMP%] {\n  background: #fffefb;\n  padding: clamp(1.2rem, 3vw, 2rem);\n  display: grid;\n  gap: 1rem;\n}\nh2[_ngcontent-%COMP%] {\n  margin: 0;\n  font-family: var(--font-display);\n  color: var(--color-ink);\n  font-size: clamp(1.6rem, 3.8vw, 2.1rem);\n}\n.mode-selector[_ngcontent-%COMP%] {\n  margin: 0;\n  padding: 0;\n  border: 0;\n  display: grid;\n  gap: 0.5rem;\n}\nlegend[_ngcontent-%COMP%] {\n  margin-bottom: 0.35rem;\n  font-weight: 700;\n  color: var(--color-ink);\n}\n.radio-chip[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 0.65rem;\n  min-height: 2.9rem;\n  padding: 0.65rem 0.9rem;\n  border-radius: 0.85rem;\n  border: 1px solid var(--color-border);\n  background: var(--color-surface-soft);\n  font-weight: 600;\n}\n.field-group[_ngcontent-%COMP%] {\n  display: grid;\n  gap: 0.4rem;\n}\n.field-label[_ngcontent-%COMP%], \nlabel[_ngcontent-%COMP%] {\n  margin: 0;\n  color: var(--color-ink);\n  font-weight: 700;\n}\n.ai-opponent[_ngcontent-%COMP%] {\n  padding: 0.75rem;\n  border: 1px dashed var(--color-border);\n  border-radius: 0.8rem;\n  background: var(--color-surface-soft);\n}\n.ai-name[_ngcontent-%COMP%] {\n  margin: 0;\n  font-weight: 700;\n  color: var(--color-ink);\n}\ninput[_ngcontent-%COMP%], \nselect[_ngcontent-%COMP%], \nbutton[_ngcontent-%COMP%] {\n  font: inherit;\n}\ninput[_ngcontent-%COMP%], \nselect[_ngcontent-%COMP%] {\n  width: 100%;\n  min-height: 2.75rem;\n  border: 1px solid var(--color-border);\n  border-radius: 0.7rem;\n  padding: 0.6rem 0.75rem;\n  background: #fff;\n  color: var(--color-ink);\n}\ninput[_ngcontent-%COMP%]:focus-visible, \nselect[_ngcontent-%COMP%]:focus-visible, \n.play-button[_ngcontent-%COMP%]:focus-visible, \n.radio-chip[_ngcontent-%COMP%]:has(input:focus-visible) {\n  outline: 3px solid color-mix(in srgb, var(--color-accent) 50%, white);\n  outline-offset: 1px;\n}\n.error-text[_ngcontent-%COMP%] {\n  margin: 0;\n  color: var(--color-danger);\n  font-weight: 700;\n  font-size: 0.9rem;\n}\n.multiplayer-fields[_ngcontent-%COMP%] {\n  display: grid;\n  gap: 0.75rem;\n}\n.play-button[_ngcontent-%COMP%] {\n  min-height: 2.9rem;\n  border: 0;\n  border-radius: 0.8rem;\n  color: #fff;\n  background:\n    linear-gradient(\n      120deg,\n      var(--color-action),\n      #e75a3f);\n  font-family: var(--font-display);\n  font-size: 1.15rem;\n  letter-spacing: 0.01em;\n  cursor: pointer;\n  transition: transform 80ms ease-out, filter 120ms ease-out;\n}\n.play-button[_ngcontent-%COMP%]:active {\n  transform: translateY(1px) scale(0.99);\n}\n.play-button[_ngcontent-%COMP%]:disabled {\n  cursor: not-allowed;\n  filter: grayscale(0.2);\n  opacity: 0.55;\n}\n@media (min-width: 900px) {\n  .lobby-layout[_ngcontent-%COMP%] {\n    grid-template-columns: 1.1fr 1fr;\n    gap: 1.75rem;\n  }\n}\n/*# sourceMappingURL=lobby.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(Lobby, [{
    type: Component,
    args: [{ selector: "app-lobby", imports: [FormField], template: `<main class="lobby-layout">
  <section class="hero" aria-labelledby="lobby-title">
    <div class="hero-card">
      <p class="eyebrow">Juego de cartas tradicional</p>
      <h1 id="lobby-title">La Escobini Kapitxorna</h1>
      <p class="hero-copy">Configura la partida y empieza a jugar.</p>

      <div class="hero-decoration" data-testid="hero-decoration" aria-hidden="true">
        <span>OROS</span>
        <span>COPAS</span>
        <span>ESPADAS</span>
        <span>BASTOS</span>
  ...
  <section class="setup-panel" aria-label="Configuracion de la partida">
    <h2>Configurar partida</h2>

    <fieldset class="mode-selector">
      <legend>Modo de juego</legend>

      <label class="radio-chip" for="mode-single">
        <input
          id="mode-single"
          type="radio"
          name="game-mode"
          ...
          (change)="setMode('Single Player')"
          (keydown.arrowright)="setMode('Multiplayer')"
          (keydown.arrowdown)="setMode('Multiplayer')"
        />
        <span>Un Jugador</span>
      </label>

      <label class="radio-chip" for="mode-multiplayer">
        <input
          id="mode-multiplayer"
          type="radio"
          name="game-mode"
          ...
          [checked]="!isSinglePlayerMode()"
          (change)="setMode('Multiplayer')"
          (keydown.arrowleft)="setMode('Single Player')"
          (keydown.arrowup)="setMode('Single Player')"
        />
        <span>Multi jugador</span>
      </label>
    </fieldset>

    @if (isSinglePlayerMode()) {
      <div class="field-group">
        <label for="single-player-name">Nombre del jugador</label>
        <input
          id="single-player-name"
          type="text"
          data-testid="single-player-name"
          [formField]="singlePlayerForm.name"
          (blur)="onSingleNameBlur()"
          [attr.aria-invalid]="singleNameErrorVisible()"
          [attr.aria-describedby]="singleNameErrorVisible() ? 'single-player-name-error' : null"
        />
        @if (singleNameErrorVisible()) {
          <p
            id="single-player-name-error"
            data-testid="single-player-name-error"
            class="error-text"
            role="alert"
          >
      ...
      <div class="field-group ai-opponent">
        <p class="field-label">Oponente IA</p>
        <p class="ai-name" data-testid="ai-name">Laia</p>
      </div>
      ...
      <div class="field-group">
        ...
        <select
          ...
          [value]="multiplayerPlayerCount()"
          (change)="onPlayerCountChange($any($event.target).value)"
        >
      ...
      <div class="multiplayer-fields">
        @for (playerIndex of visibleMultiplayerIndexes(); track playerIndex) {
          <div class="field-group">
            <label [for]="'multiplayer-name-' + (playerIndex + 1)">
              Jugador {{ playerIndex + 1 }}
            </label>
            <input
              [id]="'multiplayer-name-' + (playerIndex + 1)"
              type="text"
              [attr.data-testid]="'multiplayer-name-' + (playerIndex + 1)"
              [formField]="multiplayerForm.playerNames[playerIndex]"
              (blur)="onMultiplayerNameBlur(playerIndex)"
              [attr.aria-invalid]="isMultiplayerNameErrorVisible(playerIndex)"
              [attr.aria-describedby]="
                isMultiplayerNameErrorVisible(playerIndex)
                  ? 'multiplayer-name-error-' + (playerIndex + 1)
                  : null
              "
            />
            @if (isMultiplayerNameErrorVisible(playerIndex)) {
              <p
                [id]="'multiplayer-name-error-' + (playerIndex + 1)"
                [attr.data-testid]="'multiplayer-name-error-' + (playerIndex + 1)"
                class="error-text"
                role="alert"
              >
                El nombre es obligatorio.
...
`, styles: ["/* src/app/features/lobby/lobby/lobby.scss */\n:host {\n  display: block;\n}\n.lobby-layout {\n  min-height: 100dvh;\n  display: grid;\n  gap: 1.5rem;\n  padding: clamp(1rem, 3vw, 2.5rem);\n  align-items: stretch;\n}\n.hero,\n.setup-panel {\n  border-radius: 1.25rem;\n  box-shadow: 0 12px 30px rgba(18, 36, 52, 0.12);\n}\n.hero {\n  background:\n    linear-gradient(\n      160deg,\n      #ffd3ab,\n      #a6e8ee);\n  color: #0f2c3a;\n  overflow: hidden;\n}\n.hero-card {\n  height: 100%;\n  padding: clamp(1.25rem, 3vw, 2.5rem);\n  display: grid;\n  gap: 0.85rem;\n  align-content: center;\n}\n.eyebrow {\n  margin: 0;\n  text-transform: uppercase;\n  letter-spacing: 0.08em;\n  font-weight: 700;\n  font-size: 0.78rem;\n  opacity: 0.9;\n}\nh1 {\n  margin: 0;\n  font-family: var(--font-display);\n  line-height: 1;\n  font-size: clamp(2.2rem, 6vw, 4rem);\n}\n.hero-copy {\n  margin: 0;\n  max-width: 30ch;\n  line-height: 1.5;\n}\n.hero-decoration {\n  margin-top: 0.75rem;\n  display: flex;\n  gap: 0.55rem;\n  flex-wrap: wrap;\n}\n.hero-decoration span {\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  min-height: 2.75rem;\n  padding: 0.45rem 0.9rem;\n  border-radius: 999px;\n  background: rgba(255, 255, 255, 0.55);\n  border: 1px solid rgba(15, 44, 58, 0.25);\n  color: #123746;\n  font-size: 0.85rem;\n  font-weight: 700;\n}\n.setup-panel {\n  background: #fffefb;\n  padding: clamp(1.2rem, 3vw, 2rem);\n  display: grid;\n  gap: 1rem;\n}\nh2 {\n  margin: 0;\n  font-family: var(--font-display);\n  color: var(--color-ink);\n  font-size: clamp(1.6rem, 3.8vw, 2.1rem);\n}\n.mode-selector {\n  margin: 0;\n  padding: 0;\n  border: 0;\n  display: grid;\n  gap: 0.5rem;\n}\nlegend {\n  margin-bottom: 0.35rem;\n  font-weight: 700;\n  color: var(--color-ink);\n}\n.radio-chip {\n  display: flex;\n  align-items: center;\n  gap: 0.65rem;\n  min-height: 2.9rem;\n  padding: 0.65rem 0.9rem;\n  border-radius: 0.85rem;\n  border: 1px solid var(--color-border);\n  background: var(--color-surface-soft);\n  font-weight: 600;\n}\n.field-group {\n  display: grid;\n  gap: 0.4rem;\n}\n.field-label,\nlabel {\n  margin: 0;\n  color: var(--color-ink);\n  font-weight: 700;\n}\n.ai-opponent {\n  padding: 0.75rem;\n  border: 1px dashed var(--color-border);\n  border-radius: 0.8rem;\n  background: var(--color-surface-soft);\n}\n.ai-name {\n  margin: 0;\n  font-weight: 700;\n  color: var(--color-ink);\n}\ninput,\nselect,\nbutton {\n  font: inherit;\n}\ninput,\nselect {\n  width: 100%;\n  min-height: 2.75rem;\n  border: 1px solid var(--color-border);\n  border-radius: 0.7rem;\n  padding: 0.6rem 0.75rem;\n  background: #fff;\n  color: var(--color-ink);\n}\ninput:focus-visible,\nselect:focus-visible,\n.play-button:focus-visible,\n.radio-chip:has(input:focus-visible) {\n  outline: 3px solid color-mix(in srgb, var(--color-accent) 50%, white);\n  outline-offset: 1px;\n}\n.error-text {\n  margin: 0;\n  color: var(--color-danger);\n  font-weight: 700;\n  font-size: 0.9rem;\n}\n.multiplayer-fields {\n  display: grid;\n  gap: 0.75rem;\n}\n.play-button {\n  min-height: 2.9rem;\n  border: 0;\n  border-radius: 0.8rem;\n  color: #fff;\n  background:\n    linear-gradient(\n      120deg,\n      var(--color-action),\n      #e75a3f);\n  font-family: var(--font-display);\n  font-size: 1.15rem;\n  letter-spacing: 0.01em;\n  cursor: pointer;\n  transition: transform 80ms ease-out, filter 120ms ease-out;\n}\n.play-button:active {\n  transform: translateY(1px) scale(0.99);\n}\n.play-button:disabled {\n  cursor: not-allowed;\n  filter: grayscale(0.2);\n  opacity: 0.55;\n}\n@media (min-width: 900px) {\n  .lobby-layout {\n    grid-template-columns: 1.1fr 1fr;\n    gap: 1.75rem;\n  }\n}\n/*# sourceMappingURL=lobby.css.map */\n"] }]
  }], () => [], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Lobby, { className: "Lobby", filePath: "src/app/features/lobby/lobby/lobby.ts", lineNumber: 22 });
})();
export {
  Lobby
};
//# sourceMappingURL=chunk-RRCLWRX6.js.map
